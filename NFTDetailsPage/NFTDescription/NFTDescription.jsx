...
const NFTDescription = ({ nft }) => {
  ...
  if (!nft || !nft.seller || !nft.owner) {
    // Handle the case where nft or its properties are undefined or null
    return null; // Or display an error message or loading spinner
  }
